  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved info as @info" do
        ...
        post :create, {:info => { "name" => "invalid value" }}, valid_session
        assigns(:info).should be_a_new(Info)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested info" do
        ...
        Info.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => info.to_param, :info => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the info as @info" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Info.any_instance.stub(:save).and_return(false)
        put :update, {:id => info.to_param, :info => { "name" => "invalid value" }}, valid_session
        assigns(:info).should eq(info)
      end
